      ...
      <div class="cart_inner">
          ...
          <table class="table">
            <thead>
              <tr>
				...
				<th><input type="checkbox" id="check" checked value="noChk"><input type="hidden" value="no"></th>
              </tr>
            </thead>
            <tbody>
		...
		<!--계산을 위한 곳-->
					<tr>
						...
						<td><input type="hidden" id="ppn" value="${cart.productNumber}"><input type="hidden" name="ppm" value="${cart.productPrice}"><input type="checkbox" checked><input type="hidden" value="yes"></td>
					</tr>
				</c:if>
				</c:forEach>
				</div>
